...
/**
 * Adds a usage attribution ID to the Places Client, for Google internal metrics.
 * This attribution ID helps Google understand which resources are helpful to developers.
